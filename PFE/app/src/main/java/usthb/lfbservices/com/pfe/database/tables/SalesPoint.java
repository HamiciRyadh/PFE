...
public class SalesPoint {
    ...
    public SalesPoint(String salesPointId, double salesPointLat, double salesPointLong, String salesPointName, String salesPointAddress, String salesPointPhoneNumber, String salesPointWebSite, double salesPointRating, String salesPointPhotoReference, String salesPointWilaya) {
        this.salesPointId = salesPointId;
        this.salesPointLat = salesPointLat;
        this.salesPointLong = salesPointLong;
        this.salesPointName = salesPointName;
